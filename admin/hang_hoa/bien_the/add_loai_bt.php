...
<form class="mt-4 sm:mt-4 sm:flex-none" method="POST" id="add_bt" action="<?php echo $url_action_add_bt ?>">
        ...
        <div class="flex flex-col">
            <div>
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <input type="text" id="tong_so_luong" name="tong_so_luong" autocomplete="family-name"
                            class="block w-full rounded-md border-gray-300 shadow-sm focus-visible:outline-none border-2 px-1 py-2 sm:text-sm">
                    </div>
                </div>
            </div>
