...
<div class="sm:flex sm:items-center">
    <div class="sm:flex-auto">
        ...
        <p class="mt-2 text-sm text-gray-700">Thêm Danh Mục</p>
    </div>

</div>
<form class="mt-4 sm:mt-4 sm:flex-none" method="POST" id="add_danh_muc" action="index.php">
    <span>Thêm mới</span>
