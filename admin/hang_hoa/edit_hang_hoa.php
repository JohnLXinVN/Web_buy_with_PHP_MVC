            ...
            <div class="sm:col-span-2">
                ...
                <div class="mt-1">
                    <textarea type="text" rows="4" name="desc" id="desc"
                        class="block w-full rounded-md border-gray-300 shadow-sm focus-visible:outline-none border-2 px-1 py-2 sm:text-sm"><?php echo $data_edit["description"]; ?></textarea>
                </div>
            </div>
            <div class="sm:col-span-2">
                ...
                <div class="mt-1">
                    <select id="ma_loai" name="ma_loai" autocomplete="country-name"
                        ...
                        foreach ($ds_loai_hang as $loai_hang) {
                            ...
                            ?>
                            <option value="<?= $loai_hang['ma_loai'] ?>" <?= $selected ?>>
                                <?= $loai_hang['ten_loai'] ?>
                            </option>
                            <?php
                        }
