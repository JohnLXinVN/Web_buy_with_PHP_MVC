    ...
    <div class="mt-10 border-t border-gray-200 pt-10">
        ...
        <div class="mt-4 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-4">
            <div>
                ...
                <div class="mt-1">
                    <input type="text" id="ten_hh" name="ten_hh" autocomplete="given-name" value="<?php echo $data_edit["ten_hh"] ?>" class="block w-full rounded-md border-gray-300 shadow-sm focus-visible:outline-none border-2 px-1 py-2 sm:text-sm">
                </div>
            </div>
            <div class="sm:col-span-2">
                <label class="block text-sm font-medium text-gray-700">Mô tả</label>
                <div class="mt-1">
                    <textarea type="text" rows="4" name="mo_ta" id="mo_ta" class="block w-full rounded-md border-gray-300 shadow-sm focus-visible:outline-none border-2 px-1 py-2 sm:text-sm"><?php echo $data_edit["mo_ta"]; ?></textarea>
                </div>
            </div>
            <div class="sm:col-span-2">
                <label class="block text-sm font-medium text-gray-700">Giảm giá</label>
                <div class="mt-1">
                    <input type="text" name="giam_gia" id="giam_gia" value="<?php echo $data_edit["giam_gia"] ?>" class="block w-full rounded-md border-gray-300 shadow-sm focus-visible:outline-none border-2 px-1 py-2 sm:text-sm">
                </div>
            </div>
            <div class="mt-4">
                ...
                <input id="hinh_no_load" name="hinh_no_load" type="text" hidden class="" value="<?php echo $data_edit["hinh"] ?>">
            ...
            <div>
                ...
                <div class="mt-1">
                    <input type="date" id="ngay_nhap" name="ngay_nhap" autocomplete="given-name" value="<?php echo $data_edit["ngay_nhap"] ?>" class="block w-full rounded-md border-gray-300 shadow-sm focus-visible:outline-none border-2 px-1 py-2 sm:text-sm">
                </div>
            </div>
            ...
            <div>
                ...
                <div class="mt-1">
                    <input type="text" id="luot_xem" name="luot_xem" readonly value="<?php echo $data_edit["luot_xem"] ?>" autocomplete="family-name" class="block w-full rounded-md border-gray-300 shadow-sm focus-visible:outline-none border-2 px-1 py-2 sm:text-sm">
                </div>
            </div>
            ...
            <div>
                ...
                <div class="mt-1">
                    <select id="ma_loai" name="ma_loai" autocomplete="country-name" class="block w-full rounded-md border-gray-300 shadow-sm focus-visible:outline-none border-2 px-1 py-2 sm:text-sm">
                        ...
                        ?>
                            <option value="<?= $loai_hang['ma_loai'] ?>" <?= $selected ?>><?= $loai_hang['ten_loai'] ?></option>
                        <?php
                        }
                        ?>
                    </select>
        ...
        <button type="submit" name="btn_edit_hang_hoa" class="mt-4 rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
            Sửa</button>
